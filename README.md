...
│   ├── train_simpsons_lora.py         # Script d'entraînement (remplace les notebooks). Dataset par défaut :
│   │                                   # kostastokis/simpsons-faces (Kaggle, visages recadrés, sans upscale IA)
